/**
 *  \file IMP/bff/ProbeAccessibleVolumeMeanDistanceRestraint.h
 ...
 *
 */
#ifndef IMPBFF_PROBEACCESSIBLEVOLUMEMEANDISTANCERESTRAINT_H
#define IMPBFF_PROBEACCESSIBLEVOLUMEMEANDISTANCERESTRAINT_H
...
class IMPBFFEXPORT ProbeAccessibleVolumeMeanDistanceRestraint : public IMP::Restraint {
...
public:
    ...
    ProbeAccessibleVolumeMeanDistanceRestraint(IMP::Model* m, IMP::ParticleIndexAdaptor p1,
    ...
    IMP_OBJECT_METHODS(ProbeAccessibleVolumeMeanDistanceRestraint);
};
...
/*!
    ...
    #IMP::bff::ProbeAccessibleVolumeMeanDistanceRestraint scores a chi-squared, which pulls at
...
/*!
    ...
    #IMP::bff::ProbeAccessibleVolumeMeanDistanceRestraint makes: the shape of a volume is taken
...
IMPBFFEXPORT void add_avs_to_rigid_bodies(const ProbeAccessibleVolumeDecorators& avs);
...
IMPBFFEXPORT void set_av_xyzr_mass(const ProbeAccessibleVolumeDecorators& avs);
...
/*!
    ...
    \param[in] mean_position_restraint score the separation of the volumes'
               *mean positions* (one #IMP::bff::ProbeAccessibleVolumeMeanDistanceRestraint per
...
#endif //IMPBFF_PROBEACCESSIBLEVOLUMEMEANDISTANCERESTRAINT_H
