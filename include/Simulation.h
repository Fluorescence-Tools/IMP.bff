...
#ifndef IMPBFF_SIMULATION_H
#define IMPBFF_SIMULATION_H
...
*/
struct IMPBFFEXPORT SimulationTrajectory {
    ...
    IMP_SHOWABLE_INLINE(SimulationTrajectory,
                        out << "SimulationTrajectory(" << n_frames
                            << " frames of " << n_atoms << " atoms, "
                            << integrator << ")");
};
IMP_VALUES(SimulationTrajectory, SimulationTrajectories);
...
class IMPBFFEXPORT ProbeSimulation {
 public:
    ...
    virtual SimulationTrajectory run(int n_steps, int write_every = 1) = 0;
