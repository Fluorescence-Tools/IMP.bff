 ...
 *
 */
#ifndef IMPBFF_POTENTIALS_H
#define IMPBFF_POTENTIALS_H
...
// -------- from Scoring.h (the restraint factories over a typed dye system) --------
// These are the IMP side of Scoring.h: everything above in that header is
