#ifndef IMPBFF_MMFDB_PROFILE_H
#define IMPBFF_MMFDB_PROFILE_H

#include <string>
#include <vector>

/**
 *  \file IMP/bff/MMFDBProfile.h
 ...
 *
 * `pto::File` frames bytes and deliberately knows nothing about what
 ...
 * bytes needs `pto::File` and nothing here. That property is what lets
