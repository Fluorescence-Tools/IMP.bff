/**
 *  \file IMP/bff/PotentialTables.h
 ...
 * `Potentials.h` and the tables are here. They arrived as four loose `.npy`
 ...
 *
 */
#ifndef IMPBFF_POTENTIALTABLES_H
#define IMPBFF_POTENTIALTABLES_H
...
#endif //IMPBFF_POTENTIALTABLES_H
