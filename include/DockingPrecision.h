/**
 *  \file IMP/bff/DockingPrecision.h
 ...
 *
 */
#ifndef IMPBFF_DOCKINGPRECISION_H
#define IMPBFF_DOCKINGPRECISION_H
...
struct IMPBFFEXPORT DockingPositionUncertainty {
    ...
    DockingPositionUncertainty() : n_models(0) {}
    ...
    IMP_SHOWABLE_INLINE(DockingPositionUncertainty,
                        out << "PositionUncertainty(" << n_models
                            << " models, <rmsf> = " << get_rmsf_mean() << " A)");
};
IMP_VALUES(DockingPositionUncertainty, DockingPositionUncertainties);
...
*/
IMPBFFEXPORT DockingPositionUncertainty estimate_position_uncertainty(
...
IMPBFFEXPORT void write_position_uncertainty_pdb(
        const DockingPositionUncertainty& uncertainty,
...
IMPBFFEXPORT void write_position_uncertainty_csv(
        const DockingPositionUncertainty& uncertainty, const std::string& out_csv);

IMPBFF_END_NAMESPACE

#endif //IMPBFF_DOCKINGPRECISION_H
