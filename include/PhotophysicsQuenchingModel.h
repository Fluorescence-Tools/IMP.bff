/**
 *  \file IMP/bff/PhotophysicsQuenchingModel.h
 ...
 *
 */
#ifndef IMPBFF_PHOTOPHYSICSQUENCHINGMODEL_H
#define IMPBFF_PHOTOPHYSICSQUENCHINGMODEL_H
...
public:
    ...
    */
    PhotophysicsLifetimeSpectrum lifetime_spectrum(int n_species = 128) const;
...
#endif //IMPBFF_PHOTOPHYSICSQUENCHINGMODEL_H
