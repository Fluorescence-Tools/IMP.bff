#ifndef IMPBFF_PROBEACCESSIBLEVOLUME_H
#define IMPBFF_PROBEACCESSIBLEVOLUME_H

/**
 *  \file IMP/bff/ProbeAccessibleVolume.h
 ...
 *  everything representation-neutral): #IMP::bff::ProbeAccessibleVolume enumerates
 ...
 *
 * #IMP::bff::ProbeAccessibleVolumeDecorator is the *solver* — it grows a path map from an attachment point
 * and produces a density. #IMP::bff::ProbeAccessibleVolume is the *result*: those
...
/*!
    ...
    with it.
*/
class IMPBFFEXPORT ProbeAccessibleVolume : public States {
protected:
...
public:
    ...
    IMP_SHOWABLE_INLINE(ProbeAccessibleVolume,
...
IMP_VALUES(ProbeAccessibleVolume, ProbeAccessibleVolumes);
...
*/
IMPBFFEXPORT void write_av(const ProbeAccessibleVolume& av, const std::string& path);
...
*/
class IMPBFFEXPORT ACV : public ProbeAccessibleVolume {
...
public:
    ...
    static ACV from_accessible_volume(const ProbeAccessibleVolume& av,
...
protected:
    ...
    mutable ProbeAccessibleVolume av_;
...
public:
    ...
    const ProbeAccessibleVolume& get_accessible_volume() const;
...
#endif  // IMPBFF_PROBEACCESSIBLEVOLUME_H
