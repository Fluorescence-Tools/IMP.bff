/**
 * \file IMP/bff/ProbeForceFieldCIF.h
...
#ifndef IMPBFF_PROBEFORCEFIELDCIF_H
#define IMPBFF_PROBEFORCEFIELDCIF_H
...
/*!
    Mirrors the reader in ProbeForceFieldCIF.h. Writes the eighteen _ff_* categories
...
#endif //IMPBFF_PROBEFORCEFIELDCIF_H
