/**
 * \file IMP/bff/ProbeAccessibleVolumeDecorator.h
 ...
 *
 */
#ifndef IMPBFF_PROBEACCESSIBLEVOLUMEDECORATOR_H
#define IMPBFF_PROBEACCESSIBLEVOLUMEDECORATOR_H
...
*/
class IMPBFFEXPORT ProbeAccessibleVolumeDecorator : public IMP::core::Gaussian {
...
public:
    ...
    */
    ...
    IMP_DECORATOR_METHODS(ProbeAccessibleVolumeDecorator, IMP::core::Gaussian);

    /** Setup the particle with unspecified AV - uses default values. */
    IMP_DECORATOR_SETUP_1(ProbeAccessibleVolumeDecorator, IMP::ParticleIndex, pi_source);
     ...
     * in it, so an #IMP::bff::ProbeAccessibleVolumeOccupancyRegistry adopts the first radii
     ...
     */
    void set_occupancy_registry(ProbeAccessibleVolumeOccupancyRegistry *registry);
    ProbeAccessibleVolumeOccupancyRegistry *get_occupancy_registry() const;
...
IMP_DECORATORS(ProbeAccessibleVolumeDecorator, ProbeAccessibleVolumeDecorators, ParticlesTemp);
...
IMPBFFEXPORT double av_distance(
        const ProbeAccessibleVolumeDecorator& a,
        const ProbeAccessibleVolumeDecorator& b,
 ...
 * points (ProbeAccessibleVolumeDecorator::get_quadrature_points); the pair quantity is the weighted
...
*/
IMPBFFEXPORT void write_av(const ProbeAccessibleVolumeDecorator& av, const std::string& path);
...
IMPBFFEXPORT double av_overlap(
        const ProbeAccessibleVolumeDecorator& av, const IMP::atom::Hierarchy& hierarchy,
...
// -------- the doors over an IMP::Model (formerly ProbeAccessibleVolumeBuilder.h) --------
...
*/
IMPBFFEXPORT ProbeAccessibleVolume resample_av(
...
*/
IMPBFFEXPORT ProbeAccessibleVolume get_av_from_structure(
...
*/
IMPBFFEXPORT std::map<std::string, ProbeAccessibleVolume> get_avs_for_structure(
        const std::string& positions_json, const std::string& pdb_path,
        double disc_step = -1.0);

IMPBFF_END_NAMESPACE

#endif /* IMPBFF_PROBEACCESSIBLEVOLUMEDECORATOR_H */