#ifndef IMPBFF_LINKER_H
#define IMPBFF_LINKER_H

/**
 *  \file IMP/bff/Linker.h
 *  \brief A dye's linker: its rotatable degrees of freedom, and sampling them.
 *
 * Two former headers: the **geometry** (formerly `LinkerGeometry.h`) --
 * applying a torsion/angle configuration to a linker -- and the **sampler**
 * (formerly `LinkerSampling.h`) -- Metropolis over those configurations, and
 * the rotamer library it makes.
 *
 *  Copyright 2007-2026 IMP Inventors. All rights reserved.
 */

// -------- from LinkerGeometry.h --------
/**
 * (formerly IMP/bff/LinkerGeometry.h, now a section of this file)
