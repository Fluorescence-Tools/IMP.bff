#ifndef IMPBFF_PHOTOPHYSICSQUENCHING_H
#define IMPBFF_PHOTOPHYSICSQUENCHING_H

/**
 *  \file IMP/bff/PhotophysicsQuenching.h
 ...
 * order it is used:
 *
 * 1. **Tables** (formerly `PETPhotophysicsQuenching.h`) -- which moieties quench
 ...
 *
 * `PhotophysicsQuenchingModel.h` stays a header of its own: it composes these with the
 * accessible volume, the walk and the grid solver, and it reaches
 * `PhotophysicsInteractionTerms.h`, which reaches the tables here -- so the model cannot
 * live in the same file as the tables without including itself.
 *
 *  Copyright 2007-2026 IMP Inventors. All rights reserved.
 */

// -------- from PETPhotophysicsQuenching.h --------
/**
 *  (formerly IMP/bff/PETPhotophysicsQuenching.h, now a section of this file)
...
#endif  // IMPBFF_PHOTOPHYSICSQUENCHING_H
