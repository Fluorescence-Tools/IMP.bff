/** \file IMP/bff/FRETRotamer.h
 * Copyright 2007-2026 IMP Inventors. All rights reserved.
 */
#ifndef IMPBFF_FRETROTAMER_H
#define IMPBFF_FRETROTAMER_H
...
struct IMPBFFEXPORT FRETRotamerFrameResult {
...
class IMPBFFEXPORT FRETRotamer {
    ...
    ProbeRotamerSiteOptions site_;
    ProbeRotamerLibrary lib_1_, lib_2_;
    bool fixed_r0_;
    ...
    FRETRotamer(const std::vector<ProteinFrame>& frames,
                ...
                const ProbeRotamerSiteOptions& site, bool fixed_R0, double r0,
...
public:
    ...
    FRETRotamer(const std::string& protein,
    ...
    static FRETRotamer from_frames(
    ...
    FRETRotamerFrameResult frame_fret(const ProteinFrame& frame);
    ...
    */
    ...
    IMP_SHOWABLE_INLINE(FRETRotamer,
