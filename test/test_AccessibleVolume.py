...
class Tests(unittest.TestCase):
    ...
    def test_decorate_particle(self):
        ...
        np.testing.assert_almost_equal(av.get_mean_position(), (-15.8831, 19.3749, 20.0382), decimal=3)
    ...
    def test_AccessibleVolumeDecorator(self):
        ...
        ref = (0.750007, -25.434758, -1.198424)   # lattice-anchored, 26-stencil (PRD-105)
    ...
    def test_av_random_distances(self):
        ...
        self.assertAlmostEqual(np.mean(distances), 54.5652, delta=0.15)
    ...
    def test_av_av_distance(self):
        ...
        refs_distances = [53.7789, 54.5563, 52.3026, 0.4497]
    ...
    def test_distance_distributions(self):
        ...
        p_rda_ref = np.array(
            [   0.,    0.,    0.,    0.,    0.,    0.,    0.,    2.,   28.,
               68.,  127.,  250.,  435.,  624.,  892., 1144., 1352., 1386.,
             1334., 1087.,  718.,  405.,  128.,   20.,    0.,    0.,    0.,
                0.,    0.,    0.,    0.,    0.])
