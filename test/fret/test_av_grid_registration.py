...
The array path in ``IMP.bff.av.compute`` had found and fixed this already, and
...
import IMP.bff
from IMP.bff.fret.av import compute_av
...
_ARGS = (np.zeros((1, 4)), np.zeros(3), 20.0, 0.5, (3.5, 0.0, 0.0))
