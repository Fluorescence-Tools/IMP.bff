...
class TestBackboneFrame:
    ...
    def test_frame_from_coords_identity(self):
        from IMP.bff.cgdye.labeling.backbone_frame import backbone_frame_from_coords
    ...
    def test_frame_matches_reference(self):
        ...
        frame = backbone_frame_from_coords(
...
class TestAttachmentResolver:
    ...
    def test_strip_sidechain_at_site(self):
        ...
        try:
            ...
            from IMP.bff.cgdye.labeling.attachment import strip_sidechain_at_site
...
class TestDyePlacement:
    ...
    def test_place_dye_shifts_origin(self):
        ...
        frame = backbone_frame_from_coords(ca, n, c)
        from IMP.bff.cgdye.labeling.attachment import place_dye
    ...
    def test_place_dye_from_coords(self):
        import IMP
        import IMP.algebra
        import IMP.atom
        import IMP.core
        ...
        from IMP.bff.cgdye.labeling.attachment import place_dye_from_coords
...
class TestMultiDyeAttachment:
    ...
    def test_attach_two_dyes(self):
        ...
        try:
            ...
            assert results[0]["resnum"] == 1
            assert results[1]["resnum"] == 2
...
class TestRotamerAttachment:
    ...
    def test_get_anchor_cb_position(self):
        import IMP
        import IMP.atom
        from IMP.bff.cgdye.labeling.attachment import get_anchor_cb_position
