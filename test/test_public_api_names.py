...
_FAMILY = re.compile(
    ...
    r"|Dye|dye|Spectrum|spectral|spectra|FLRCIF|Label|FLUOROPHORE|Quencher|quencher|PET|pet_|REFERENCE_DYE|States|resample_av|PathMapReading|orientation|order_parameter|Term|total_rate)"
)
