"""The NMR-restraint CIF dialect, retired 2026-08-19.

Read and written by IMP.bff until it was retired. Kept because the file
format is on disk somewhere and this is the only description of it.

It defined the categories ``_nmr_restraint``, ``_nmr_component`` and their
companions, and was consumed by exactly one caller: the cgdye MD runner's
optional distance-restraint path, which was retired with it.
"""
