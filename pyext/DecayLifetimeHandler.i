...
%attribute(IMP::bff::DecayLifetimeHandler, std::vector<double>, lifetime_spectrum, get_lifetime_spectrum, set_lifetime_spectrum);

IMP_SWIG_VALUE_SERIALIZE_IMPL(IMP::bff, DecayLifetimeHandler)
