...
%ignore IMP::bff::ProbeAccessibleVolumeOccupancyMap::set_coordinate_snapshot;
IMP_SWIG_OBJECT(IMP::bff, ProbeAccessibleVolumeOccupancyMap, ProbeAccessibleVolumeOccupancyMaps);
IMP_SWIG_OBJECT(IMP::bff, ProbeAccessibleVolumeOccupancyRegistry, ProbeAccessibleVolumeOccupancyRegistries);
IMP_SWIG_DECORATOR(IMP::bff, ProbeAccessibleVolumeDecorator, ProbeAccessibleVolumeDecorators);
...
%attribute_py(IMP::bff::ProbeAccessibleVolumeDecorator, IMP::bff::PathMap, map, get_map);
