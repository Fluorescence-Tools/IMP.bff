 ...
 *
 * `ProbeAccessibleVolumeMeanDistanceRestraint` computes its gradient, so an fps.json-driven
 ...
 * `probe_network_restraint_set` in `ProbeAccessibleVolumeMeanDistanceRestraint.h`. A caller who
...
IMP_SWIG_OBJECT(IMP::bff, ProbeAccessibleVolumeMeanDistanceRestraint, ProbeAccessibleVolumeMeanDistanceRestraints);
...
%feature("kwargs") IMP::bff::ProbeAccessibleVolumeMeanDistanceRestraint::ProbeAccessibleVolumeMeanDistanceRestraint;
