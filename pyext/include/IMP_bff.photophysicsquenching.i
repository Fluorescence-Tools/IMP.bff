 ...
 *
 * `PhotophysicsQuenching.h` is four former headers in one, and this is their one interface
 ...
 * can sit here rather than next to `PhotophysicsPhotonSimulation.h` where it used to.
 *
