...
def _av_imp_bff(
    ...
    # and the AV comes back empty — FPS/LabelLib got the same clearance by
    # stripping the attachment residue's atoms instead. A position that
    # declares allowed_sphere_radius (schema field) keeps its own value.
