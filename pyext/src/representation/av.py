...
class BasicAV:
    ...
    def mean_position(self) -> np.ndarray:
        ...
        return weighted_mean(self._padded_points, self.n_points)
...
class ACV(BasicAV):
    ...
    def _update_contact_density(self):
        ...
        n_idx, n_non_idx, contact_mask, non_contact_mask = split_av_acv(
            self._density,
            self.grid_step,
            self._slow_radius,
            self._slow_centers,
