...
double my_rescale(
    ...
    double scale = 0.0;
    IMP::bff::rescale(fit, decay, &scale, start, stop);
    return scale;
}
%}
...
double my_rescale_w(
    ...
    double scale = 0.0;
    IMP::bff::rescale_w(fit, decay, w_sq, &scale, start, stop);
    return scale;
}
%}
...
double my_rescale_w_bg(
    ...
    double scale = 0.0;
    IMP::bff::rescale_w_bg(fit, decay, w_sq, bg, &scale, start, stop);
    return scale;
}
%}
...
void my_fconv(
    ...
    IMP::bff::fconv(fit, x, irf, len3 / 2, start, stop, dt);
}
%}
...
void my_fconv_avx(
    ...
    IMP::bff::fconv_avx(fit, x, irf, len3 / 2, start, stop, dt);
}
%}
...
void my_fconv_per(
    ...
    IMP::bff::fconv_per(fit, x, irf, len3 / 2, start, stop, len1, period, dt);
}
%}
...
void my_fconv_per_avx(
    ...
    IMP::bff::fconv_per_avx(fit, x, irf, len3 / 2, start, stop, len1, period, dt);
}
%}
...
void my_fconv_per_cs(
    ...
    IMP::bff::fconv_per_cs(fit, x, irf, len3 / 2, stop, len1, period, conv_stop, dt);
}
%}
...
void my_fconv_ref(
    ...
    IMP::bff::fconv_ref(fit, x, irf, len3 / 2, start, stop, tauref);
}
%}
...
void my_sconv(
    ...
    IMP::bff::sconv(fit, model, irf, start, stop);
}
%}
...
void my_shift_lamp(
    ...
    IMP::bff::shift_lamp(lampsh, lamp, ts, len1);
}
%}
