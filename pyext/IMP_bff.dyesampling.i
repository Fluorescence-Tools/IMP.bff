...
%rename(load_rotamer_library_dcd) IMP::bff::load_rotamer_library;
...
%attribute(IMP::bff::DyeDiffusionTrajectory, int, n_frames, get_n_frames);
%attribute(IMP::bff::DyeDiffusionTrajectory, int, n_accepted, get_n_accepted);
%attribute(IMP::bff::DyeDiffusionTrajectory, int, n_rejected, get_n_rejected);
%attribute(IMP::bff::DyeDiffusionTrajectory, double, acceptance_ratio,
