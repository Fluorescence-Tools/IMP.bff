...
donor = IMP.bff.ProbeRotamerEnsemble.from_site(pdb, "A", 481, "AlexaFluor 488 C1R cutoff30", position_name="A481")
acceptor = IMP.bff.ProbeRotamerEnsemble.from_site(pdb, "A", 496, "AlexaFluor 594 C1R cutoff30", position_name="A496")
...
positions = IMP.bff.fps_rotamer_positions_payload({"A481": donor, "A496": acceptor})
distances = IMP.bff.fps_rotamer_distances_from_ensembles({"A481": donor, "A496": acceptor}, [("A481", "A496")], 52.0)
IMP.bff.write_fps_rotamer("hgbp1_rotamer.fps.json", positions, distances)
